...
class DemoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Clinic::create(['name' => 'Poli Umum']);
        Clinic::create(['name' => 'Poli Gigi']);
        Clinic::create(['name' => 'Poli THT']);
        Clinic::create(['name' => 'Poli Mata']);
        Clinic::create(['name' => 'Poli Kulit']);
        Clinic::create(['name' => 'Laboratorium']);
        Clinic::create(['name' => 'Radiologi']);
    }
}
